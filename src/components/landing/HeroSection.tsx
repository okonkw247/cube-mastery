  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroCube}
          alt="3D Rubik's Cube floating in space"
      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-fade-in">
            ...
            <span className="text-sm text-muted-foreground">Join 10,000+ cubers mastering the cube</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: "0.1s" }}>
            Master the Rubik's Cube with our proven step-by-step video system. 
            From complete beginner to speedcubing pro.
          </p>
