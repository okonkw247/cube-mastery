      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button onClick={() => setLegalOpen("privacy")} className="text-muted-foreground hover:text-foreground transition-colors">
                  Privacy Policy
                </button>
              </li>
              <li>
                <button onClick={() => setLegalOpen("terms")} className="text-muted-foreground hover:text-foreground transition-colors">
                  Terms of Service
                </button>
              </li>
              <li>
                <button onClick={() => setLegalOpen("refund")} className="text-muted-foreground hover:text-foreground transition-colors">
                  Refund Policy
                </button>
              </li>
            </ul>
